...
public class Channel implements Serializable, Auditable, Migratable, Purgable, Cacheable<Channel>, ExportClearable {
    ...
    public void migrate3_5_0(DonkeyElement element) {
        ...
        if (propertiesElement != null) {
            ...
            if (tagsElement != null) {
                ...
                for (DonkeyElement tagsElementChild : tagsElement.getChildElements()) {
                    tagSet.add(tagsElementChild.getTextContent());
                }
    ...
    public Map<String, Object> getPurgedProperties() {
        return getPurgedProperties(null);
    }
    
    @Override
    public Map<String, Object> getPurgedProperties(PurgeHelper purgeHelper) {
        ChannelPurgeHelper helper = null;
        if (purgeHelper instanceof ChannelPurgeHelper) {
            helper = (ChannelPurgeHelper) purgeHelper;
        } else {
            helper = new ChannelPurgeHelper() {};
        }
        ...
        sourceProperties.put("messageStatistics", helper.getMessageStatistics(id, sourceConnector.getMetaDataId()));
        ...
        for (Connector connector : destinationConnectors) {
            ...
            destinationProperties.put("messageStatistics", helper.getMessageStatistics(id, connector.getMetaDataId()));
        ...
        purgedProperties.put("messageStatistics", helper.getMessageStatistics(id, null));
