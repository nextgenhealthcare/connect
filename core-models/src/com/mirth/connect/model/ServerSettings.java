...
public class ServerSettings extends AbstractSettings implements Serializable, Auditable, Purgable {
    ...
    public ServerSettings(String environmentName, String serverName, Properties properties, Serializer serializer) {
    ...
    public Properties getProperties(Serializer serializer) {
        ...
        if (getDefaultMetaDataColumns() != null) {
            properties.put(DEFAULT_METADATA_COLUMNS, serializer.serialize(getDefaultMetaDataColumns()));
        }
        if (getDefaultAdministratorBackgroundColor() != null) {
            properties.put(DEFAULT_ADMINISTRATOR_COLOR, serializer.serialize(getDefaultAdministratorBackgroundColor()));
        }
        if (getSmtpHost() != null) {
