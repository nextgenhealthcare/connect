...
public class RecoveryTests {
    ...
    private void createDestinationMessage(DonkeyDao dao, ConnectorMessage sourceMessage, int metaDataId, Status status) {
        ...
        destinationMessage.setContent(new MessageContent(sourceMessage.getChannelId(), sourceMessage.getMessageId(), metaDataId, ContentType.RAW, sourceMessage.getEncoded().getContent(), false));
        destinationMessage.setContent(new MessageContent(sourceMessage.getChannelId(), sourceMessage.getMessageId(), metaDataId, ContentType.PROCESSED_RAW, sourceMessage.getEncoded().getContent(), false));
        ...
        if (status == Status.PENDING || status == Status.SENT) {
            destinationMessage.setContent(new MessageContent(sourceMessage.getChannelId(), sourceMessage.getMessageId(), metaDataId, ContentType.TRANSFORMED, sourceMessage.getEncoded().getContent(), false));
            destinationMessage.setContent(new MessageContent(sourceMessage.getChannelId(), sourceMessage.getMessageId(), metaDataId, ContentType.ENCODED, sourceMessage.getEncoded().getContent(), false));
            destinationMessage.setContent(new MessageContent(sourceMessage.getChannelId(), sourceMessage.getMessageId(), metaDataId, ContentType.SENT, sourceMessage.getEncoded().getContent(), false));
            destinationMessage.setContent(new MessageContent(sourceMessage.getChannelId(), sourceMessage.getMessageId(), metaDataId, ContentType.RESPONSE, responseContent, false));
            ...
            if (status == Status.SENT) {
                destinationMessage.setContent(new MessageContent(sourceMessage.getChannelId(), sourceMessage.getMessageId(), metaDataId, ContentType.PROCESSED_RESPONSE, responseContent, false));
