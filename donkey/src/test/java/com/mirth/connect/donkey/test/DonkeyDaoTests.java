...
//        Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@10.10.15.23:1521/XE", "DONKEY", "donkey");
//        ResultSet columns = null;
//        
//        try {
//            columns = connection.getMetaData().getColumns(connection.getCatalog(), null, "D_MCM1", null);
//            ResultSetMetaData metaData = columns.getMetaData();
//            
//            while (columns.next()) {
//                for (int i = 1; i <= metaData.getColumnCount(); i++) {
//                    System.out.printf("%s: %s, ", metaData.getColumnName(i), columns.getString(i));
//                }
//                
//                System.out.println("");
//            }
...
//        Connection connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/donkeytest", "brentm", "");
//        String tableName = "table1";
//        String columnName = "test";
//        
//        Statement statement = connection.createStatement();
//        statement.execute("DROP TABLE " + tableName);
//        statement.execute("CREATE TABLE " + tableName + " (othercol INTEGER, " + columnName + " INTEGER)");
//        statement.close();
//        
////        String[] columnTypes = new String[] { "SMALLINT", "VARCHAR2(50)", "NVARCHAR2(50)", "CHAR", "NCHAR", "CLOB", "BLOB", "TIMESTAMP", "DATE", "BINARY_DOUBLE" };
//        String[] columnTypes = new String[] { "NUMERIC(30, 30)", "BIGINT", "BIT", "BOOLEAN", "BYTEA", "VARCHAR", "CHAR", "DATE", "DOUBLE PRECISION", "INTEGER", "NUMERIC(10)", "REAL", "SMALLINT", "TEXT", "TIME", "TIMESTAMP" };
////        String[] columnTypes = new String[] { "INTEGER", "SMALLINT", "BIGINT", "DECIMAL", "NUMERIC(10)", "FLOAT", "DOUBLE", "BIT", "REAL", "DOUBLE PRECISION", "DATE", "DATETIME", "TIMESTAMP", "TIME", "CHAR", "VARCHAR(50)", "BINARY", "VARBINARY(3)", "BLOB", "TEXT" };
////        String[] columnTypes = new String[] { "BIGINT", "BLOB", "CHAR", "CLOB", "DATE", "DECIMAL", "DOUBLE", "DOUBLE PRECISION", "FLOAT", "INTEGER", "LONG VARCHAR", "NUMERIC(10)", "REAL", "SMALLINT", "TIME", "TIMESTAMP", "VARCHAR(5)" };
//        
//        try {
//            for (String columnType : columnTypes) {
//                postgresAddCol(connection, tableName, columnName, columnType);
//                
//                ResultSet columns = connection.getMetaData().getColumns(connection.getCatalog(), null, tableName, null);
//    
//                while (columns.next() && !columns.getString("COLUMN_NAME").equals(columnName));
//                
//                System.out.println(columnType + " = " + sqlTypeToString(columns.getInt("DATA_TYPE")));
//                
//                columns.close();
//            }
//        } finally {
...
//    }
//    
//    private void oracleAddCol(Connection connection, String tableName, String name, String type) throws Exception {
//        Statement statement = connection.createStatement();
//
//        try {
//            statement.execute("ALTER TABLE " + tableName + " DROP COLUMN \"" + name + "\"");
//            statement.execute("ALTER TABLE " + tableName + " ADD (\"" + name + "\" " + type + ")");
//        } finally {
//            statement.close();
//        }
//    }
//    
//    private void postgresAddCol(Connection connection, String tableName, String name, String type) throws Exception {
//        Statement statement = connection.createStatement();
//
//        try {
//            statement.execute("ALTER TABLE " + tableName + " DROP COLUMN \"" + name + "\"");
//            statement.execute("ALTER TABLE " + tableName + " ADD COLUMN \"" + name + "\" " + type);
//        } finally {
//            statement.close();
//        }
//    }
//    
//    private void addCol(Connection connection, String tableName, String name, String type) throws Exception {
//        Statement statement = connection.createStatement();
//
//        try {
//            statement.execute("ALTER TABLE " + tableName + " DROP COLUMN " + name);
