...
<jsp:include page="/_jsp/header.jsp">
	<jsp:param name="pageTitle" value="New Filter" />
...
<div id="primaryContent">
	...
	<div class="breadcrumb">
		<c:choose>
			<c:when test="${!empty param.orig}">
				<a href="/channel/">Channels</a> &gt; <a href="/channel/?state=new">New Channel</a> &gt; <a href="/wizard/?state=filters">Channel Wizard</a> &gt; New Filter
			</c:when>
			<c:otherwise>
				<a href="/filter/">Filters</a> &gt; New Filter
			</c:otherwise>
		</c:choose>
	</div>
	...
	<div id="innerContent">
		...
		<form action="/filter/" method="post" onSubmit="return setScript()">
			<table id="filterForm">		
				<tr>
			...
			<fieldset id="javascript_options">
