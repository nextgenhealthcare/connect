...
public interface ConfigurationServletInterface extends BaseServletInterface {
    ...
    public void setGlobalScripts(@Param("scripts") @RequestBody(description = "The map of global scripts to update with. Script keys: Deploy, Undeploy, Preprocessor, Postprocessor", required = true, content = {
            @Content(mediaType = MediaType.APPLICATION_XML, examples = {
                    @ExampleObject(name = "globalScripts", ref = "../apiexamples/global_scripts_xml") }),
            @Content(mediaType = MediaType.APPLICATION_JSON, examples = {
