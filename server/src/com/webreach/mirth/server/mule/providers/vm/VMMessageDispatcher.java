...
package com.webreach.mirth.server.mule.providers.vm;
...
public class VMMessageDispatcher extends AbstractMessageDispatcher {
	...
	public void doDispatch(UMOEvent event) throws Exception {
		...
		try {
			...
			if (connector.isQueueEvents()) {
				...
				receiver.routeMessage(new MuleMessage(messageObject.getEncodedData()), false);
	...
	public UMOMessage doSend(UMOEvent event) throws Exception {
		...
		try {
			...
			retMessage = (UMOMessage) receiver.routeMessage(new MuleMessage(messageObject.getEncodedData()), false);
			messageObjectController.setSuccess(messageObject, "Message routed successfully");
