...
public class Mirth extends Thread {
	...
	private void printSplashScreen() {
		...
		System.out.println("Running Java " + System.getProperty("java.version") + " on " + System.getProperty("os.name") + " (" + System.getProperty("os.version") + ", " + System.getProperty("os.arch") + ") with default charset: "+java.nio.charset.Charset.defaultCharset());
	}
