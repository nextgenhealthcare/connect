...
public class WebServiceSenderProperties extends QueuedSenderProperties {
    ...
    public static final String SOAP_DEFAULT_DROPDOWN = "Press Get Operations";
    ...
    public Properties getDefaults() {
        ...
        properties.put(WEBSERVICE_OPERATION, SOAP_DEFAULT_DROPDOWN);
        ...
        defaultOperations.add(SOAP_DEFAULT_DROPDOWN);
