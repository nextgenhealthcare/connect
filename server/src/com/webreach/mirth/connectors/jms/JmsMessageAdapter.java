 ...
 * properties and payload of a JMS Message in a uniform way. The
 * JmsMessageAdapter expects a message of type <i>javax.jms.Message</i> and will
 * throw an IllegalArgumentException if the source message type is not
