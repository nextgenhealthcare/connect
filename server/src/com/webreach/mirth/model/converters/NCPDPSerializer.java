...
public class NCPDPSerializer implements IXMLSerializer<String> {
    ...
    public NCPDPSerializer(Map<String, String> properties) {
        if (properties == null) {
            return;
        }
        if (properties.get("segmentDelimiter") != null) {
            String segDel = convertNonPrintableCharacters(properties.get("segmentDelimiter"));
        ...
        if (properties.get("groupDelimiter") != null) {
            String grpDel = convertNonPrintableCharacters(properties.get("groupDelimiter"));
        ...
        if (properties.get("fieldDelimiter") != null) {
            String fieldDel = convertNonPrintableCharacters(properties.get("fieldDelimiter"));
