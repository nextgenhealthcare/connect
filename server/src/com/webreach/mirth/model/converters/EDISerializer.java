...
public class EDISerializer implements IXMLSerializer<String> {
    ...
    public EDISerializer(Map<String, String> properties) {
        if (properties == null) {
            return;
        }
        if (properties.get("segmentDelimiter") != null) {
            this.segmentDelim = convertNonPrintableCharacters(properties.get("segmentDelimiter"));

        }
        if (properties.get("elementDelimiter") != null) {
            this.elementDelim = convertNonPrintableCharacters(properties.get("elementDelimiter"));
        }
        if (properties.get("subelementDelimiter") != null) {
            this.subelementDelim = convertNonPrintableCharacters(properties.get("subelementDelimiter"));
        }
        return;
    }
