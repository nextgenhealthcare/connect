...
public class _BHS extends Segment {
	public _BHS(){
		...
		fieldDescriptions = new String[]{"Batch Field Separator", "Batch Encoding Characters", "Batch Sending Application", "Batch Sending Facility", "Batch Rcving Application", "Batch Receiving Facility", "Batch Creation Date/Time", "Batch Security", "Batch Name/Id/Type", "Batch Comment", "Batch Control ID", "Reference Batch Cntrl ID"};
