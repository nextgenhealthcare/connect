...
public class _AD extends Composite {
	public _AD(){
		...
		fieldDescriptions = new String[]{"Street Address (ST)", "Other Designation", "City", "State or Province", "Zip or Postal Code", "Country", "Address Type", "Other Geographic Designation"};
		description = "Address";
		name = "AD";
	}
}
