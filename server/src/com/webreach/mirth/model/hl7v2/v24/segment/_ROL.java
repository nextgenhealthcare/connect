...
public class _ROL extends Segment {
	public _ROL(){
		...
		fieldDescriptions = new String[]{"Role Instance ID", "Action Code", "Role", "Role Person", "Role Begin Date/Time", "Role End Date/Time", "Role Duration", "Role Action Reason", "Provider Type", "Organization Unit Type", "Office/Home Address", "Phone"};
		description = "Role";
		name = "ROL";
	}
}
