...
public class _XON extends Composite {
	public _XON(){
		...
		fieldDescriptions = new String[]{"Organization Name", "Organization Name Type Code", "ID Number (NM)", "Check Digit", "Code Identifying the Check Digit Scheme Employed", "Assigning Authority", "Identifier Type Code", "Assigning Facility ID", "Name Representation Code"};
