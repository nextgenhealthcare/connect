...
public class _IN3 extends Segment {
	public _IN3(){
		fields = new Class[]{_SI.class, _CX.class, _XCN.class, _ID.class, _PEN.class, _TS.class, _TS.class, _XCN.class, _DT.class, _DT.class, _DTN.class, _CE.class, _TS.class, _XCN.class, _ST.class, _XTN.class, _CE.class, _CE.class, _XTN.class, _PCF.class, _ST.class, _DT.class, _IS.class, _IS.class, _XCN.class};
