...
public class _MFA extends Segment {
	public _MFA(){
		...
		fieldDescriptions = new String[]{"Record-level Event Code", "MFN Control ID", "Event Completion Date/Time", "MFN Record Level Error Return", "Primary Key Value – MFA", "Primary Key Value Type"};
