...
public class _MSH extends Segment {
	public _MSH(){
		fields = new Class[]{_ST.class, _ST.class, _HD.class, _HD.class, _HD.class, _HD.class, _TS.class, _ST.class, _MSG.class, _ST.class, _PT.class, _VID.class, _NM.class, _ST.class, _ID.class, _ID.class, _ID.class, _ID.class, _CE.class, _ID.class};
