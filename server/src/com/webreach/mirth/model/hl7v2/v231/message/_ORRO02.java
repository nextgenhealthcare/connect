...
public class _ORRO02 extends Message{	
	public _ORRO02(){
		...
		required = new boolean[]{true, true, false, false, true, false, true, false, false, false, false, false, false, false, false};
		groups = new int[][]{{5, 6, 0, 0}, {8, 13, 0, 1}, {7, 15, 1, 1}, {5, 15, 0, 0}}; 
