...
public class _CM2 extends Segment {
	public _CM2(){
		...
		fieldDescriptions = new String[]{"Set ID", "Scheduled Time Point", "Description of Time Point", "Events Scheduled This Time Point"};
		description = "Clinical Study Schedule Master Segment";
		name = "CM2";
	}
}
