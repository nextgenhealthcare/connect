...
public class _PR1 extends Segment {
	public _PR1(){
		fields = new Class[]{_SI.class, _IS.class, _CE.class, _ST.class, _TS.class, _IS.class, _NM.class, _XCN.class, _IS.class, _NM.class, _XCN.class, _XCN.class, _CE.class, _NM.class, _CE.class, _CE.class};
