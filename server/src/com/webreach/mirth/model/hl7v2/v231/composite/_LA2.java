...
public class _LA2 extends Composite {
	public _LA2(){
		...
		fieldDescriptions = new String[]{"Point of Care (IS)", "Room", "Bed", "Facility (HD)", "Location Status", "Person Location Type", "Building", "Floor", "Street Address", "Other Designation", "City", "State or Province", "Zip or Postal Code", "Country", "Address Type", "Other Geographic Designation"};
