...
public class _PEO extends Segment {
	public _PEO(){
		...
		fieldDescriptions = new String[]{"Event Identifiers Used", "Event Symptom/Diagnosis Code", "Event Onset Date/Time", "Event Exacerbation Date/Time", "Event Improved Date/Time", "Event Ended Data/Time", "Event Location Occurred Address", "Event Qualification", "Event Serious", "Event Expected", "Event Outcome", "Patient Outcome", "Event Description From Others", "Event From Original Reporter", "Event Description From Patient", "Event Description From Practitioner", "Event Description From Autopsy", "Cause of Death", "Primary Observer Name", "Primary Observer Address", "Primary Observer Telephone", "Primary Observer’s Qualification", "Confirmation Provided By", "Primary Observer Aware Date/Time", "Primary Observer’s iIdentity May Be Divulged"};
