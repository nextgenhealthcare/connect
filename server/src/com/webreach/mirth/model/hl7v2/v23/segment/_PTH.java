...
public class _PTH extends Segment {
	public _PTH(){
		...
		fieldDescriptions = new String[]{"Action Code", "Pathway ID", "Pathway Instance ID", "Pathway Established Date/Time", "Pathway Lifecycle Status", "Change Pathway Lifecycle Status Date/Time"};
		description = "Pathway";
		name = "PTH";
	}
}
