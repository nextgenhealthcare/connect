...
public class _LRL extends Segment {
	public _LRL(){
		...
		fieldDescriptions = new String[]{"Primary Key Value", "Segment Action Code", "Segment Unique Key", "Location Relationship ID", "Organization Location Relationship Value", "Patient Location Relationship Value"};
