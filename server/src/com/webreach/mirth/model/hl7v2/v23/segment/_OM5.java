...
public class _OM5 extends Segment {
	public _OM5(){
		...
		fieldDescriptions = new String[]{"Sequence Number - Test/ Observation Master File", "Test/Observations Included w/An Ordered Test Battery", "Observation ID Suffixes"};
