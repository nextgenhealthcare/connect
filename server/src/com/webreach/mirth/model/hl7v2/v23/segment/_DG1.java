...
public class _DG1 extends Segment {
	public _DG1(){
		fields = new Class[]{_SI.class, _ID.class, _CE.class, _ST.class, _TS.class, _IS.class, _CE.class, _CE.class, _ID.class, _IS.class, _CE.class, _NM.class, _CP.class, _ST.class, _NM.class, _XCN.class, _IS.class, _ID.class, _TS.class};
