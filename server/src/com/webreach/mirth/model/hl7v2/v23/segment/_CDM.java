...
public class _CDM extends Segment {
	public _CDM(){
		...
		fieldDescriptions = new String[]{"Primary Key Value", "Charge Code Alias", "Charge Description Short", "Charge Description Long", "Description Override Indicator", "Exploding Charges", "Procedure Code", "Active/Inactive Indicator", "Inventory Number", "Resource Load", "Contract Number", "Contract Organization", "Room Fee Indicator"};
