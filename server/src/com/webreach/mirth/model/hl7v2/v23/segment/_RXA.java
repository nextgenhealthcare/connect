...
public class _RXA extends Segment {
	public _RXA(){
		fields = new Class[]{_NM.class, _NM.class, _TS.class, _TS.class, _CE.class, _NM.class, _CE.class, _CE.class, _CE.class, _XCN.class, _CM.class, _ST.class, _NM.class, _CE.class, _ST.class, _TS.class, _CE.class, _CE.class, _CE.class, _ID.class, _ID.class, _TS.class};
