...
public class _PPN extends Composite {
	public _PPN(){
		fields = new Class[]{_ST.class, _FN.class, _ST.class, _ST.class, _ST.class, _ST.class, _IS.class, _IS.class, _HD.class, _ID.class, _ST.class, _ID.class, _ID.class, _HD.class, _TS.class, _ID.class, _CE.class, _DR.class, _ID.class, _TS.class, _TS.class, _ST.class, _CWE.class, _CWE.class};
