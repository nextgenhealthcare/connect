...
public class _BTSO31 extends Message{	
	public _BTSO31(){
		segments = new Class[]{_MSH.class, _SFT.class, _NTE.class, _PID.class, _PD1.class, _NTE.class, _PV1.class, _PV2.class, _ORC.class, _TQ1.class, _TQ2.class, _BPO.class, _NTE.class, _BTX.class, _NTE.class};
