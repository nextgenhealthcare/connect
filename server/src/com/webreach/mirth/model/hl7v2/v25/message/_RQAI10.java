...
public class _RQAI10 extends Message{	
	public _RQAI10(){
		...
		groups = new int[][]{{4, 5, 0, 0}, {6, 7, 1, 1}, {11, 13, 1, 1}, {10, 13, 0, 0}, {19, 20, 0, 0}, {18, 20, 0, 1}, {23, 24, 0, 1}, {21, 24, 0, 1}, {25, 26, 0, 0}}; 
		description = "Request For Resubmission of An Authorization";
		name = "RQAI10";
	}
}
