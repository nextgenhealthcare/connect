...
public class _CDM extends Segment {
	public _CDM(){
		fields = new Class[]{_CE.class, _CE.class, _ST.class, _ST.class, _IS.class, _CE.class, _CE.class, _ID.class, _CE.class, _NM.class, _CX.class, _XON.class, _ID.class};
		repeats = new int[]{0, -1, 0, 0, 0, -1, -1, 0, -1, 0, -1, -1, 0};
