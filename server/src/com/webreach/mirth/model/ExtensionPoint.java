...
public class ExtensionPoint {
	...
	public enum Type{
		SERVER_PLUGIN, SERVER_CONNECTOR_STATUS, CLIENT_PANEL, CLIENT_VOCABULARY, CLIENT_FILTER_RULE, CLIENT_TRANSFORMER_STEP, CLIENT_DASHBOARD_COLUMN, CLIENT_DASHBOARD_PANE, ATTACHMENT_VIEWER
	};
	private String name;
	private Type type;
