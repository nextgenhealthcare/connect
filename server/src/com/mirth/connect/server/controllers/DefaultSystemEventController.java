...
public class DefaultSystemEventController extends SystemEventController {
    private Logger logger = Logger.getLogger(this.getClass());
    private static DefaultSystemEventController instance = null;

    private DefaultSystemEventController() {

    }

    public static SystemEventController create() {
        synchronized (DefaultSystemEventController.class) {
            if (instance == null) {
                instance = new DefaultSystemEventController();
            }
