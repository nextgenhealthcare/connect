...
/**
 * Allows users to generate HL7 v2.x acknowledgments based on an inbound
 * message, with a specified ACK code and custom text message. This class will
 * not work as expected if the HL7 v2.x data type plugin is disabled or
 * uninstalled.
 */
public class ACKGenerator {
    ...
    /**
     * Generates an HL7 v2.x acknowledgment. Assumes that the inbound message is
     * proper ER7, and uses the default format "yyyyMMddHHmmss" for the MSH.7
     * message date/time.
     * 
     * @param message
