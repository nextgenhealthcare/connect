        ...
        return new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                if (proxy instanceof MirthServlet) {
                    ...
                    /*
                     * If a DontCheckAuthorized annotation is present on the server implementation
                     * method, then no auditing is done now and the servlet is expected to call
                     * checkUserAuthorized. Two other optional annotations determine whether the
                     * channel/user ID should be used in the authorization check.
                     */
                    ...
                    if (checkAuthorized) {
                        /*
                         * We need to know what parameter index the channel/user ID resides at so we
                         * can correctly include it with the authorization request.
                         */
                        ...
                        if (args.length > 0) {
                            ...
                            if (paramNames == null) {
                                ...
                                /*
                                 * The Param annotation lets us know at runtime the name to use when
                                 * adding entries into the parameter map, which will eventually be
