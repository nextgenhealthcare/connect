...
public class Encrypter {
    ...
    public Encrypter(SecretKey key) throws EncryptionException {
        try {
            ...
            throw new EncryptionException("Error initializing encrypter.", e);
        }
    }
    ...
    public String encrypt(String source) throws EncryptionException {
        ...
        try {
            ...
            throw new EncryptionException("Error encrypting string.", e);
        }
    }
    ...
    public String decrypt(String source) throws EncryptionException {
        ...
        try {
            ...
            throw new EncryptionException("Error decrypting string.", e);
        }
    }
}
