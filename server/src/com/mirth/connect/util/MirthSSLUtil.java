...
public class MirthSSLUtil {
    ...
    public static final String[] DEFAULT_HTTPS_CLIENT_PROTOCOLS = new String[] { "TLSv1.3",
            "TLSv1.2", "TLSv1.1" };
    public static final String[] DEFAULT_HTTPS_SERVER_PROTOCOLS = new String[] { "TLSv1.3",
    ...
    public static final String[] DEFAULT_HTTPS_CIPHER_SUITES = new String[] {
            ...
            "TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256", "TLS_AES_256_GCM_SHA384",
