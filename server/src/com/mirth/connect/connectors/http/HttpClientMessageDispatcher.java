...
public class HttpClientMessageDispatcher extends AbstractMessageDispatcher implements QueueEnabledMessageDispatcher {
     ...
     * 
     * @see
     * org.mule.providers.AbstractConnectorSession#doDispatch(org.mule.umo.UMOEvent
     * )
     */
    ...
    protected HttpMethod execute(UMOEndpointURI endpointURI, boolean closeConnection, MessageObject messageObject) throws Exception {
         ...
         * = (HttpMethod) body; } else if ("GET".equalsIgnoreCase(method) ||
         * body instanceof NullPayload) { httpMethod = new
         * GetMethod(uri.toString()); } else { PostMethod postMethod = new
         * PostMethod(uri.toString());
         * 
