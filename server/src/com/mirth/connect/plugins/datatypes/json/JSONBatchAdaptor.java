...
public class JSONBatchAdaptor extends BatchAdaptor {
    ...
    public JSONBatchAdaptor(BatchAdaptorFactory factory, SourceConnector sourceConnector, BatchMessageSource batchMessageSource) {
        super(factory, sourceConnector, batchMessageSource);
    }

    public JSONBatchProperties getBatchProperties() {
        return batchProperties;
    }

    public void setBatchProperties(JSONBatchProperties batchProperties) {
