...
import static com.mirth.connect.util.StringUtil.unescape;
...
public class DelimitedSerializerProperties {
	...
	public DelimitedSerializerProperties(Map delimitedProperties) {
