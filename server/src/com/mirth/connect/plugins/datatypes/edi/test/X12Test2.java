...
package com.mirth.connect.plugins.datatypes.edi.test;
...
public class X12Test2 {
	...
	public static void main(String[] args) {
		try {
			...
			TransactionType collection = (TransactionType) ((JAXBElement<TransactionType>) unmarshaller.unmarshal(X12Test2.class.getResourceAsStream("xml/997.4010.xml"))).getValue();
