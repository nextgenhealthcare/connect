...
public interface DashboardConnectorStatusServletInterface extends BaseServletInterface {
    ...
    public String getChannelState(@Param("channelId") @Parameter("The channel ID to return a dashboard status for.") @PathParam("channelId") String channelId) throws ClientException;
