...
public interface UserServletInterface extends BaseServletInterface {
    ...
    public void createUser(@Param("user") @Parameter(description = "The User object to create.", required = true) User user) throws ClientException;
    ...
    public void updateUser(// @formatter:off
            ...
            @Param("user") @Parameter(description = "The User object to update.", required = true) User user) throws ClientException;
    // @formatter:on
