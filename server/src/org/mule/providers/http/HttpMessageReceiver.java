...
//                    }
                    ...
                    if (response instanceof String){
                        if (returnMessage.getProperty(HttpConstants.HEADER_CONTENT_TYPE) != null){
                        	response = ((String)response).replaceFirst("Content-Type: text/plain", "Content-Type: " + returnMessage.getProperty(HttpConstants.HEADER_CONTENT_TYPE));
                        }
                        dataOut.write(((String)response).getBytes());
                    }
