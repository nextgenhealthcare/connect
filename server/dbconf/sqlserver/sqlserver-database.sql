...
ALTER TABLE CHANNEL_ALERT ADD CONSTRAINT ALERT_ID_CA_FK FOREIGN KEY (ALERT_ID) REFERENCES ALERT (ID) ON DELETE CASCADE;
...
ALTER TABLE ALERT_EMAIL ADD CONSTRAINT ALERT_ID_AE_FK FOREIGN KEY (ALERT_ID) REFERENCES ALERT(ID) ON DELETE CASCADE;
