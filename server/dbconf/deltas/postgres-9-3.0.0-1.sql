...
ALTER TABLE EVENT ALTER COLUMN DATE_CREATED TYPE TIMESTAMP WITH TIME ZONE

ALTER TABLE PERSON ALTER COLUMN LAST_LOGIN TYPE TIMESTAMP WITH TIME ZONE

ALTER TABLE PERSON ALTER COLUMN GRACE_PERIOD_START TYPE TIMESTAMP WITH TIME ZONE

ALTER TABLE PERSON_PASSWORD ALTER COLUMN PASSWORD_DATE TYPE TIMESTAMP WITH TIME ZONE