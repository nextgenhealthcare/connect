...
CREATE TABLE tasks (
	task_id integer GENERATED ALWAYS AS IDENTITY (START WITH 1) NOT NULL PRIMARY KEY,
...
CREATE TABLE reprocessing (
	reprocessing_id integer GENERATED ALWAYS AS IDENTITY (START WITH 1) NOT NULL PRIMARY KEY,
	user_id integer NOT NULL,
	message_id bigint NOT NULL,
	completed boolean NOT NULL DEFAULT false
);

CREATE INDEX reprocessing_index1 ON reprocessing(user_id);

CREATE INDEX reprocessing_index2 ON reprocessing(completed);
