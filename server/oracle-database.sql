...
CREATE OR REPLACE TRIGGER TRIGGER_INSERT_EVENT_ID
...
CREATE OR REPLACE TRIGGER TRIGGER_INSERT_SEQ_ID  
BEFORE INSERT ON MESSAGE FOR EACH ROW
BEGIN  
SELECT MESSAGE_SEQUENCE.NEXTVAL  
INTO :NEW.SEQUENCE_ID FROM DUAL;  
END;
/
...
CREATE OR REPLACE TRIGGER TRIGGER_INSERT_PERSON_ID  
...
CREATE OR REPLACE TRIGGER TRIGGER_INSERT_CONF_ID  
BEFORE INSERT ON CONFIGURATION FOR EACH ROW
BEGIN  
SELECT CONFIGURATION_SEQUENCE.NEXTVAL  
INTO :NEW.ID FROM DUAL;  
END;
/
