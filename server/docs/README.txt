...
/logs: Debug logs generated by Mirth Connect and its sub-components
...
Mirth.bat, Mirth.exe, mirth.sh: Starts the Mirth Connect server
Shell.bat, shell.sh: Starts the Mirth Connect command console
