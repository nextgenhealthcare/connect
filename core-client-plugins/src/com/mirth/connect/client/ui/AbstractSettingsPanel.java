...
public abstract class AbstractSettingsPanel extends JPanel {
    ...
    public AbstractSettingsPanel(String tabName) {
        ...
        addTask(TaskConstants.SETTINGS_REFRESH, "Refresh", "Refresh " + tabName + " settings.", "", new ImageIcon(FrameBase.class.getResource("images/arrow_refresh.png")));
        saveIndex = addTask(TaskConstants.SETTINGS_SAVE, "Save", "Save " + tabName + " settings.", "", new ImageIcon(FrameBase.class.getResource("images/disk.png")));
