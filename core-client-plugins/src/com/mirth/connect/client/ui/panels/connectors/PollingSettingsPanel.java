...
public class PollingSettingsPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        advancedSettingsButton = new JButton(new ImageIcon(FrameBase.class.getResource("images/wrench.png")));
    ...
    public void updateNextFireTime() {
        if (channelContext && nextFireTimeProperties != null) {
            ...
            if (isCron || checkProperties(null, false)) {
                try {
                    PollConnectorJobHandler handler = new PollConnectorJobHandler(nextFireTimeProperties, PlatformUI.MIRTH_FRAME.getClient().getGuid(), false);
