...
public class DummyChannel extends Channel {
    ...
    public DummyChannel(String channelId, String serverId, SourceConnector sourceConnector, DestinationConnector destinationConnector) {
        ...
        if (destinationConnector != null) {
            ...
            destinationConnector.setFilterTransformerExecutor(new FilterTransformerExecutor(new DataType("XML", new TestSerializer(), new TestAutoResponder()), new DataType("XML", new TestSerializer(), new TestAutoResponder())));
    ...
    public Message process(ConnectorMessage sourceMessage, boolean waitForDestinations) throws InterruptedException {
        ...
        sourceMessage.getResponseMap().put(SourceConnectorProperties.RESPONSE_POST_PROCESSOR, new Response(Status.SENT, ""));
