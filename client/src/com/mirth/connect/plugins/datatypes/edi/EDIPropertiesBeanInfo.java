...
public class EDIPropertiesBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( com.mirth.connect.plugins.datatypes.edi.EDIProperties.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_elementDelimiter] = new PropertyDescriptor ( "elementDelimiter", com.mirth.connect.plugins.datatypes.edi.EDIProperties.class, "getElementDelimiter", "setElementDelimiter" ); // NOI18N
            ...
            properties[PROPERTY_segmentDelimiter] = new PropertyDescriptor ( "segmentDelimiter", com.mirth.connect.plugins.datatypes.edi.EDIProperties.class, "getSegmentDelimiter", "setSegmentDelimiter" ); // NOI18N
            ...
            properties[PROPERTY_subelementDelimiter] = new PropertyDescriptor ( "subelementDelimiter", com.mirth.connect.plugins.datatypes.edi.EDIProperties.class, "getSubelementDelimiter", "setSubelementDelimiter" ); // NOI18N
