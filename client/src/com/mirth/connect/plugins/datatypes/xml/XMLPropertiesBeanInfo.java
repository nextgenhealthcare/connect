...
public class XMLPropertiesBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( com.mirth.connect.plugins.datatypes.xml.XMLProperties.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_stripNamespaces] = new PropertyDescriptor ( "stripNamespaces", com.mirth.connect.plugins.datatypes.xml.XMLProperties.class, "isStripNamespaces", "setStripNamespaces" ); // NOI18N
