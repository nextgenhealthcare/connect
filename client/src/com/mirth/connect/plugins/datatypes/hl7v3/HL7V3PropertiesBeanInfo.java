...
public class HL7V3PropertiesBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( com.mirth.connect.plugins.datatypes.hl7v3.HL7V3Properties.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_stripNamespaces] = new PropertyDescriptor ( "stripNamespaces", com.mirth.connect.plugins.datatypes.hl7v3.HL7V3Properties.class, "isStripNamespaces", "setStripNamespaces" ); // NOI18N
