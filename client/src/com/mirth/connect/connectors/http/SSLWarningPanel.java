...
public class SSLWarningPanel extends JPanel implements HyperlinkListener {
    ...
    public SSLWarningPanel() {
        ...
        editorPane.setText("<html><body class=\"ssl-warning-panel\"><b><span style=\"color:#404040\">Important Notice:</span></b> The default system certificate store will be used for this connection. As a result, certain security options are not available and mutual authentication (two-way authentication) is not supported.<br/><br/>The <a href=\"https://www.mirth.com/Products-and-Services/Mirth-Connect#tab_extensions?extension=ssl-manager\">SSL Manager extension</a> for Mirth Connect provides advanced security and certificate management enhancements, including the ability to import certificates for use by source or destination connectors, as well as the ability to configure hostname verification and client authentication settings. For more information please contact <a href=\"https://www.mirth.com/About-Us/Contact-Us\">Mirth sales</a>.</body></html>");
        add(editorPane, "grow");
    }
