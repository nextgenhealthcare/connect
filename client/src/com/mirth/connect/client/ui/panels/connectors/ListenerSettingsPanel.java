...
//    	listenerSettingsLayout.setBorder(BorderFactory.createEmptyBorder());
    	listenerSettingsLayout.add(addressLabel, "right");
    	listenerSettingsLayout.add(allRadio);
    	listenerSettingsLayout.add(specificRadio);
    	listenerSettingsLayout.add(addressField);
    	listenerSettingsLayout.add(portLabel, "newline, right");
