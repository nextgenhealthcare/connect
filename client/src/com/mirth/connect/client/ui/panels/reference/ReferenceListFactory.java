...
public class ReferenceListFactory {
    ...
    private ArrayList<CodeTemplate> setupUtilityItems() {
        ...
        variablelistItems.add(new CodeTemplate("Get DICOM image slice count", "Retruns the number of image slices within the uncompressed DICOM image", "DICOMUtil.getSliceCount(connectorMessage)", CodeSnippetType.CODE, ContextType.GLOBAL_CONTEXT.getContext()));
