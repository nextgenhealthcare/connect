    ...
    public boolean isCellEditable(Object node, int column) {
        ...
        if (node instanceof DataTypeConnectorTableNode) {
            ...
            if (column == DataTypesDialog.INBOUND_COLUMN) {
                ...
                if (destinations.contains(tableNode.getContainerIndex()) || (tableNode.getContainerIndex() == 0 && ((Frame) PlatformUI.MIRTH_FRAME).channelEditPanel.getRequiredInboundDataType() != null)) {
                    editable = false;
                }
            }
            ...
            if (column == DataTypesDialog.OUTBOUND_COLUMN) {
                ...
                if (tableNode.getContainerIndex() == 0 && ((Frame) PlatformUI.MIRTH_FRAME).channelEditPanel.getRequiredOutboundDataType() != null) {
                    editable = false;
                }
            }
        }
