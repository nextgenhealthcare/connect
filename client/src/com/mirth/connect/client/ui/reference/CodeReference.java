...
public class CodeReference extends Reference {
    ...
    public CodeReference(int scope, String category, String name, String description, String replacementCode) {
        super(Type.CODE, scope, category, name, description, replacementCode);
