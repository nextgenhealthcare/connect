...
public class ReferenceListFactory {
    ...
    private void addCodeTemplateReferences() {
        ...
        addReference(new ParameterizedCodeReference(CONTEXT_GLOBAL, Category.UTILITY.toString(), "Create Attachment Entry", "Create Attachment Entry for use various Senders.", "var ${attachmentEntry} = new AttachmentEntry(${name}, ${content}, ${type});"));
        addReference(new ParameterizedCodeReference(CONTEXT_GLOBAL, Category.UTILITY.toString(), "Copy Attachment Entry", "Copy an Attachment Entry.", "var ${attachmentEntry} = new AttachmentEntry(${attachmentEntry});"));
