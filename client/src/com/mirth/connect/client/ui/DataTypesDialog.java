...
public class DataTypesDialog extends MirthDialog {
    ...
    private boolean updateInboundDataType(TreeTableNode node, String dataType, boolean updateDestinationInbound) {
		...
		if (node instanceof DataTypeConnectorTableNode) {
			...
			if (!(PlatformUI.MIRTH_FRAME.channelEditPanel.getRequiredDataType() != null && type == TransformerType.SOURCE) 
        ...
        table.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (editMode == EditMode.SINGLE && !e.getValueIsAdjusting()) {
                    ...
                    inboundPropertiesPanel.getDataTypeComboBox().setEnabled(!(type == TransformerType.DESTINATION || (type == TransformerType.SOURCE && PlatformUI.MIRTH_FRAME.channelEditPanel.getRequiredDataType() != null)));
