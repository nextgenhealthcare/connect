...
public class JMSReader extends ConnectorClass
{
    ...
    public Properties getProperties()
    {
        ...
        properties.put(JMSReaderProperties.JMS_CONNECTION_FACTORY, connectionFactory.getText());
    ...
    public void setProperties(Properties props)
    {
        ...
        connectionFactory.setText((String) props.get(JMSReaderProperties.JMS_CONNECTION_FACTORY));
    ...
    public boolean checkProperties(Properties props)
    {
        ...
        if (((String) props.getProperty(JMSReaderProperties.JMS_CONNECTION_FACTORY)).length() == 0)
        {
            valid = false;
