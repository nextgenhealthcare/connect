...
public class TCPSender extends ConnectorClass
{
    ...
    public Properties getProperties()
    {
        ...
        if (usePersistentQueuesYesRadio.isSelected())
            properties.put(TCPSenderProperties.TCP_USE_PERSISTENT_QUEUES, UIConstants.YES_OPTION);
        else
    ...
    public void setProperties(Properties props)
    {
        ...
        // ast:queued
        if (((String) props.get(TCPSenderProperties.TCP_USE_PERSISTENT_QUEUES)).equals(UIConstants.YES_OPTION))
