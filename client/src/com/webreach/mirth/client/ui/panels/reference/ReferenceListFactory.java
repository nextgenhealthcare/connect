...
public class ReferenceListFactory
{
    ...
    private ArrayList<ReferenceListItem> getConversionItems()
    {
        ...
        variablelistItems.add(new ReferenceListItem("Convert HL7 to XML", "Converts an encoded HL7 string to XML", "SerializerFactory.getHL7Serializer(useStrictParser, useStrictValidation).toXML(message);", CodeSnippetType.FUNCTION));
