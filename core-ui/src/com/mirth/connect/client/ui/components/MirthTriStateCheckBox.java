...
/**
 * This is a checkbox component that has a third "PARTIAL" state. It is only meant to work with the
 * JGoodies PlasticXPLookAndFeel
 *
 */
public class MirthTriStateCheckBox extends JCheckBox {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (((TriStateModel) model).getState() == PARTIAL) {
            ...
            g2.setColor(isEnabled() ? UIManager.getColor("CheckBox.check").brighter().brighter() : MetalLookAndFeel.getControlDisabled());
