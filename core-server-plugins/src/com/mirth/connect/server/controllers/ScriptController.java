...
public abstract class ScriptController extends Controller {
    ...
    public abstract void compileGlobalScripts(ContextFactory contextFactory, boolean multiServer);

    public abstract void compileChannelScripts(ContextFactory contextFactory, Channel channel) throws ScriptCompileException;
    
    public abstract void compileChannelScripts(Map<String, ContextFactory> contextFactories, Channel channel) throws ScriptCompileException;
    ...
    public abstract void executeChannelDebugDeployScript(ContextFactory contextFactory, String channelId, String channelName, MirthScopeProvider scopeProvider) throws Exception;

    public abstract void executeChannelDeployScript(ContextFactory contextFactory, String channelId, String channelName) throws Exception;

    // Undeploy Script Execution

    public abstract void executeGlobalUndeployScript() throws Exception;

    public abstract void executeChannelUndeployScript(ContextFactory contextFactory, String channelId, String channelName) throws Exception;

    public abstract void executeChannelDebugUndeployScript(ContextFactory contextFactory, String channelId, String channelName) throws Exception;
}
