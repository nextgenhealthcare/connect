...
public class StatisticsTest {
    ...
    @Before
    public void setup() {
        statisticNoNegativeValues = new Statistics(new DummyEventDispatcherProvider(), false); // default statistics object does not allow negative values
        statisticAllowNegatives = new Statistics(new DummyEventDispatcherProvider(), false, true);
    }
    ...
    private class DummyEventDispatcherProvider implements EventDispatcherProvider {
