...
import org.mule.providers.llprouter.protocols.DefaultProtocol;
import org.mule.umo.lifecycle.InitialisationException;
import org.mule.util.ClassHelper;


/**
 * <code>LLPRouter</code> routes HL7 messages to internal vmrouter listeners.
 ...
 */
public class LlpRouterConnector extends AbstractServiceEnabledConnector
{
    ...
    public void doInitialise() throws InitialisationException
    {
        ...
        if (tcpProtocol == null) {
            try {
                ...
                throw new InitialisationException(new Message("llprouter", 3), e);
            }
        }
    }
    ...
    public boolean getGenerateACKs(){
    	return generateACKs;
    }
    public void setGenerateACKs(boolean value){
    	generateACKs = value;
    }
