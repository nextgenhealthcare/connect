...
public class LlpRouterMessageDispatcherFactory implements UMOMessageDispatcherFactory
{
    public UMOMessageDispatcher create(UMOConnector connector) throws UMOException
    {
        return new LlpRouterMessageDispatcher((LlpRouterConnector) connector);
    }
}
