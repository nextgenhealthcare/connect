 ...
 */
public class VMRouterMessageAdapter extends AbstractMessageAdapter
{
    /**
    ...
    public VMRouterMessageAdapter(UMOMessage message) throws MessageTypeNotSupportedException
    {
        setMessage(message);
    }
