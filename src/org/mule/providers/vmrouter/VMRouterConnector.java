...
public class VMRouterConnector extends AbstractServiceEnabledConnector
{
    ...
    VMRouterMessageReceiver getReceiver(UMOEndpointURI endpointUri) throws EndpointException
    {
        return (VMRouterMessageReceiver) getReceiverByEndpoint(endpointUri);
    }
