 ...
 */
public class VMRouterMessageReceiver extends TransactedPollingMessageReceiver
{
    private VMRouterConnector connector;
    private Object lock = new Object();

    public VMRouterMessageReceiver(UMOConnector connector, UMOComponent component, UMOEndpoint endpoint)
            throws InitialisationException
    {
        super(connector, component, endpoint, new Long(10));
        this.connector = (VMRouterConnector) connector;
