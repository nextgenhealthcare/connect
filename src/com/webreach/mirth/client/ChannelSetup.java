...
public class ChannelSetup extends javax.swing.JPanel
{
     ...
     */
    public ChannelSetup(ArrayList<ChannelInfo> channelViews)
    {
        initComponents();
    ...
    {
        currentChannel = channelViews.get(index);
    }
    
    private void removeChannel() 
    {                                             
        channelViews.remove(currentChannel);
    }                                            

    private void addChannel() 
    {                                          
        ChannelInfo newChannel = new ChannelInfo();
        newChannel.setChannelName("New Channel");
        channelViews.add(newChannel);
    }                    
    ...
    private void initComponents()
    {
        ...
        layout.setHorizontalGroup(
            ...
            .add(channelView, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 797, Short.MAX_VALUE)
        );
...
// TODO add your handling code here:
    ...
    private void summarySaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_summarySaveActionPerformed
        // TODO add your handling code here:
        currentChannel.setChannelName(summaryChannelName.getText());
