...
public class Stats extends JFrame {
    ...
    private JXTable stats;
    private int row;
    private JPanel panel1;
    
    public Stats(JFrame parent, int row) 
    {
        this.row = row;
        ...
        panel1 = new JPanel();
        this.add(panel1);
        setTitle("Stats: " + (String)this.parent.statusListPage.statusTable.getValueAt(row,this.parent.statusListPage.getColumnNumber("Name")));
        stats = makeStatsTable();
        mainPanel.setViewportView(stats);
        ...
        layout.setHorizontalGroup(
            ...
            .add(mainPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, stats.getWidth(), Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(mainPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, stats.getHeight(), Short.MAX_VALUE)
        );
    ...
    private JXTable makeStatsTable()
    {
