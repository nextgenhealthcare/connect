...
public class Messages extends JFrame {
    ...
    public Messages(JFrame parent, int row) 
    {
        ...
        panel1 = new JPanel();
        this.add(panel1);
        setTitle("Messages: " + (String)this.parent.statusListPage.statusTable.getValueAt(row,this.parent.statusListPage.getColumnNumber("Name")));
        messages = makeMessagesTable();
        ...
        layout.setHorizontalGroup(
            ...
            .add(mainPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, messages.getWidth(), Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(mainPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, messages.getHeight(), Short.MAX_VALUE)
        );
    ...
    private JXTable makeMessagesTable()
    {
