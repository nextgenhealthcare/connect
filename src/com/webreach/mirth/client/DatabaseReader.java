...
public class DatabaseReader extends ConnectorClass
{
    ...
    public Properties getProperties()
    {
        ...
        properties.put("DatabaseReader_Driver", databaseDriverCombobox.getSelectedItem());
        properties.put("DatabaseReader_URL", databaseURLField.getText());
        properties.put("DatabaseReader_Username", databaseUsernameField.getText());
        properties.put("DatabaseReader_Password", databasePasswordField.getText());
        properties.put("DatabaseReader_SQLQuery", databaseSQLTextArea.getText());
        return properties;
    }
    
    public void setProperties(Properties props)
    {
        databaseDriverCombobox.setSelectedItem(props.get("DatabaseReader_Driver"));
        databaseURLField.setText((String)props.get("DatabaseReader_URL"));
        databaseUsernameField.setText((String)props.get("DatabaseReader_Username"));
        databasePasswordField.setText((String)props.get("DatabaseReader_Password"));
        databaseSQLTextArea.setText((String)props.get("DatabaseReader_SQLQuery"));
    }
